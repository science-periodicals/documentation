      ...
      <aside id={FormatAward.ds3Id} className="format">
        ...
        <p className="pattern">
          <code>
            ...
            <span className="token">,</span> description{' '}
          </code>
        </p>
        <p>where:</p>
        <dl>
          ...
          <dd>
            A description providing additional information about the award /
            project / grant.
          </dd>
        </dl>
        <p>
        ...
        <ul className="example">
          ...
          <li>
            <span className="award">
              award number 3R01TW005869-06S1 <code className="token">"</code>{' '}
              ...
              <span className="person cross-reference">Peter John Smith</span>
            </span>
          </li>
          <li>
